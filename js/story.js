...
(function () {
  ...
  function uraChapter(j) {
    ...
    switch (j) {
      // 裏第一章 楽園の設計図（資産5億）— 「誰も凍えさせない場所」の起工。
      case 0: return [ head('〜 5億の使い道 〜', 'bg-aurora'),
        nar('FIRE達成から半年。あの5万円の朝が、遠い昔のようだった。', { bgImg: 'bg_skytree.jpg', dur: 2200 }),
        nar('ハルの純資産は、いつのまにか5億を超えていた。', { bgImg: 'bg_skytree.jpg', dur: 2100 }),
        sc('peace', '5億か…。自販機にコイン飲み込まれて泣いてた男が、よく言うよな。', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2300 }),
        sc('peace', 'でもさ、ペッパー。…金が増えても、心は、あんまり変わらないもんだな。', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2200 }),
        sc('pepper', '当然だ。君の幸福度は、所持金とほぼ無相関でな。…昔から、肉まん半分で最大化していた。ピピッ。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2400 }),
        sc('peace', 'はは、覚えてたのか。…あの定食屋のコロッケと、コンビニの肉まんな。', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2200 }),
        sc('dog', '（あの頃のハル、財布は軽かったけど、笑顔は今と同じだったワン）', { bg: 'bg-aurora', kb: true, dur: 2100 }),
        sc('peace', '…そうだ。だから、決めてたことがある。金は、目的じゃない。', { bg: 'bg-aurora', form: 'awaken', kb: true, dur: 2200 }),
        nar('彼は窓を開け、まだ寒い早朝の風を、胸いっぱいに吸い込んだ。', { bgImg: 'bg_skytree.jpg', dur: 2000 }),
        sc('peace', '覚えてるか、みんな。誰も凍えさせない場所を作る——その約束、今日から動かす。', { bg: 'bg-aurora', form: 'awaken', fx: 'zoom', kb: true, dur: 2400 }),
        sc('pepper', '了解した。…では現実的な話を。土地・建物・10年分の運営費。試算を回す。ピピッ。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2200 }),
        sc('pepper', '結論。5億で「楽園」の設計図が引ける。…ただし、利益は一切出ない構造だ。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2300 }),
        sc('peace', '上等だよ。儲けるためなら、最初から作らない。…帰る場所がほしい奴のための場所だ。', { bg: 'bg-aurora', kb: true, dur: 2300 }),
        sc('dog', '（ハルの夢が、ただの夢じゃなくなる日が、ついに来たワン…！）', { bg: 'bg-aurora', kb: true, dur: 2000 }),
        nar('——その日、ハルは郊外の小さな丘を買った。日当たりだけは、誰にも負けない土地だった。', { bgImg: 'bg_haven.svg', dur: 2200 }),
        sc('peace', 'ここだ。…陽がよく当たる。…冬でも、ここなら、凍えないだろ。', { bgImg: 'bg_haven.svg', kb: true, dur: 2200 }),
        sc('pepper', '日照条件、最良。…だが地価は割高だった。経済合理性ゼロ。…君らしい買い物だ。', { bgImg: 'bg_haven.svg', kb: true, dur: 2300 }),
        sc('peace', 'いいんだよ。…陽だまりに、値段はつけられない。…母さんが好きだった縁側みたいな場所にする。', { bgImg: 'bg_haven.svg', form: 'awaken', kb: true, dur: 2400 }),
        sc('dog', '（お母さんの縁側…。ハルが子供の頃、二人で日向ぼっこした、あの場所ワン）', { bgImg: 'bg_haven.svg', kb: true, dur: 2300 }),
        sc('peace', '炊き出しの食堂、誰でも泊まれる部屋、子供が走り回れる庭。…全部、ここに作る。', { bgImg: 'bg_haven.svg', fx: 'zoom', kb: true, dur: 2300 }),
        nar('——幕間。設計を進める中、ハルのもとに、思わぬ仲間が訪ねてきた。', { bgImg: 'bg_park.svg', dur: 1900 }),
        sc('gian', 'よお大将！　でけえ土地買ったって聞いてよ。…道場の子供連れて、手伝いに来たぜ！', { bgImg: 'bg_park.svg', kb: true, dur: 2200 }),
        sc('peace', 'ガン太…！　お前、まさか子供たちまで。…いいのか、勉強の時間だろ。', { bgImg: 'bg_park.svg', kb: true, dur: 2100 }),
        sc('gian', 'バカ言え。人のために汗かくのも、立派な勉強だ。…お前が、オレに教えてくれたことだろ。', { bgImg: 'bg_park.svg', kb: true, dur: 2400 }),
        sc('peace', '…ガン太。お前、本当に変わったな。…昔は「お前の出玉もオレのもの」だったのに。', { bgImg: 'bg_park.svg', kb: true, dur: 2300 }),
        sc('gian', 'うるせえ、その話はすんな!!　…ま、変えてくれたのは、お前だよ。…照れるから一回しか言わねえ。', { bgImg: 'bg_park.svg', fx: 'shake', kb: true, dur: 2300 }),
        sc('dog', '（ガン太の後ろの子供たち、目をキラキラさせてるワン。…ここが、もう「楽園」になってるワン）', { bgImg: 'bg_park.svg', kb: true, dur: 2300 }),
        nar('夕暮れ。汗を流した一日の終わり、ハルは丘の上で、ひとり空を見上げた。', { bgImg: 'bg_haven.svg', dur: 2100 }),
        sc('peace', '（母さん。…約束の場所、いま、土台ができたよ。…笑って暮らせる場所、作るからな。）', { bgImg: 'bg_haven.svg', form: 'awaken', kb: true, dur: 2500 }),
        sc('pepper', '相棒。…経営的には大赤字のプロジェクトだ。…だが、私の幸福ログは、過去最高値を更新中だ。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2400 }),
        sc('peace', 'はは。…ロボのお前が幸せなら、間違ってないってことだな。', { bgImg: 'bg_haven.svg', kb: true, dur: 2000 }),
        sc('dog', '（ハルの夢の最初の一歩。…5万円の頃から、ずっと変わらない、あったかい夢ワン）', { bgImg: 'bg_haven.svg', kb: true, dur: 2200 }),
        nar('小さな丘に、最初の杭が打たれた。それは、世界を変える物語の、本当の始まりだった。', { bgImg: 'bg_haven.svg', dur: 2200 }),
        sc('peace', 'よし。…名前は決めてある。…「ひだまり」。…誰でも、いつでも、帰ってこられる場所だ。', { bgImg: 'bg_haven.svg', form: 'awaken', fx: 'zoom', kb: true, dur: 2400 }),
        sc('legend', '——未来の君よ。その一杭が、いつか何百万の人を温める。…見届けているぞ。', { bg: 'bg-legend', form: 'ghost', kb: true, dur: 2300 }),
        sc('peace', 'ああ。…まだ5億だ。…でも、夢の大きさは、金じゃ測れない。…ここから、もっと大きくする。', { bg: 'bg-aurora', form: 'awaken', fx: 'zoom', kb: true, dur: 2300 }),
        t('楽園の、設計図。', '〜 物語は、まだ続く 〜', { bg: 'bg-legend', dur: 1900, color: '#ff6ec7' }) ];

      // 裏第二章 仲間たちのその後（資産10億）— 仲間それぞれの新しい人生。
      case 1: return [ head('〜 それぞれの道 〜', 'bg-gold'),
        nar('総資産10億。ハルの夢に巻き込まれた仲間たちにも、それぞれの春が訪れていた。', { bgImg: 'bg_park.svg', dur: 2100 }),
        nar('ハルは、久しぶりに皆の顔を見て回る旅に出た。', { bgImg: 'bg_park.svg', dur: 1900 }),
        sc('gian', 'よお大将！　見てけよ、オレの道場！　チビどもがこんなに集まってんだ。', { bgImg: 'bg_park.svg', fx: 'zoom', kb: true, dur: 2100 }),
        sc('gian', 'オレぁ子供向けの道場を開いてな。「奪う」んじゃなく「守る」強さを教えてんだ。', { bgImg: 'bg_park.svg', kb: true, dur: 2300 }),
        sc('peace', 'ガキ大将が、今や先生か。…あの「お前のものはオレのもの」のガン太がなあ。', { bgImg: 'bg_park.svg', kb: true, dur: 2200 }),
        sc('gian', 'だーかーら、その話はすんなっつってんだろ!!　…でも、まあ。…奪うより、守る方が、強えって知ったんだ。', { bgImg: 'bg_park.svg', fx: 'shake', kb: true, dur: 2400 }),
        sc('dog', '（道場の壁に「居場所は奪うな、作れ」って書いてあるワン。…ガン太の宝物ワン）', { bgImg: 'bg_park.svg', kb: true, dur: 2300 }),
        nar('——次に訪ねたのは、街の中心に立つ、真新しいビル。', { bgImg: 'bg_skytree.jpg', dur: 1900 }),
        sc('hero', 'よく来たな、相棒。…俺は財団を作った。夢を諦めかけた奴に、そっと手を貸す。', { bg: 'bg-gold', form: 'gold', kb: true, dur: 2300 }),
        sc('hero', 'お前の背中を見て、決めたよ。…黄色いマントは脱いだが、ヒーローは辞めちゃいねえ。', { bg: 'bg-gold', form: 'gold', kb: true, dur: 2400 }),
        sc('peace', 'ヒーロー…。あんた、リーチで何度もオレを助けてくれた。…今度は、世界中を助けてるんだな。', { bg: 'bg-gold', kb: true, dur: 2300 }),
        sc('hero', '助けられたのは、俺の方さ。…諦めない奴を見てると、こっちが元気をもらうんだ。…お前がそうだった。', { bg: 'bg-gold', form: 'gold', kb: true, dur: 2400 }),
        nar('——幕間。豪腕ゴリ将軍は、なんと農園を開いていた。', { bgImg: 'bg_haven.svg', dur: 1900 }),
        sc('gorilla', 'ウホ。…この腕で、土を耕す。…バナナ農園だ。…腹を空かせた者に、もう、ひもじい思いはさせん。', { bgImg: 'bg_haven.svg', kb: true, dur: 2400 }),
        sc('peace', '将軍…！　あの怪力で、畑を。…似合ってるよ。…すごく、あったかい仕事だ。', { bgImg: 'bg_haven.svg', kb: true, dur: 2200 }),
        sc('gorilla', 'ウホ。…お前の楽園に、ここのバナナを全部送る。…腹が満ちれば、人は、笑える。…そうだろう。', { bgImg: 'bg_haven.svg', kb: true, dur: 2400 }),
        sc('dog', '（将軍、子供にバナナの剥き方を教えてるワン。…こわい顔なのに、手つきが優しいワン）', { bgImg: 'bg_haven.svg', kb: true, dur: 2300 }),
        nar('——夜空の下。宇宙人ゼは、星を見上げながら、地球の言葉を勉強していた。', { bg: 'bg-aurora', dur: 1900 }),
        sc('alien', 'ハル。…我、母星ニ、帰ラヌコトニシタ。…地球ノ「宴」ノ温カサ、忘レラレヌ。', { bg: 'bg-aurora', kb: true, dur: 2300 }),
        sc('alien', '今ハ、子供タチニ、星ノ話ヲシテイル。…笑顔ガ、星ノ数ホド、増エテイク。…良イ星ダ、地球ハ。', { bg: 'bg-aurora', kb: true, dur: 2500 }),
        sc('peace', 'ゼ…。お前、すっかり地球が気に入ったんだな。…ずっと、いてくれよ。…仲間だろ。', { bg: 'bg-aurora', kb: true, dur: 2200 }),
        sc('alien', '仲間。…良イ言葉ダ。…我ノ星ニハ、ナイ概念。…胸ガ、温カイ。…コレモ、財産カ。', { bg: 'bg-aurora', kb: true, dur: 2400 }),
        nar('——そして、紳士マスターは、小さな喫茶店のマスターになっていた。', { bgImg: 'bg_diner.svg', dur: 1900 }),
        sc('gent', 'いらっしゃいませ。…どうぞ、おかけください。…一杯目は、いつでも、無料でございます。', { bgImg: 'bg_diner.svg', kb: true, dur: 2300 }),
        sc('peace', '紳士マスター…！　あんた、店を。…一杯目は無料って、それじゃ商売にならないだろ。', { bgImg: 'bg_diner.svg', kb: true, dur: 2200 }),
        sc('gent', 'ふふ。…疲れた人に、温かい一杯を。…利益より、大切なものを、あなたに教わりましたので。', { bgImg: 'bg_diner.svg', kb: true, dur: 2400 }),
        sc('dog', '（あの定食屋のおばちゃんも、コロッケ包んでくれたワン。…優しさは、ちゃんと巡るワン）', { bgImg: 'bg_diner.svg', kb: true, dur: 2300 }),
        sc('peace', 'みんな…それぞれの場所で、誰かを照らしてるんだな。', { bgImg: 'bg_park.svg', kb: true, dur: 2000 }),
        sc('peace', '（あの肉まん一個を、三人で分け合った夜。…あれが、全部の始まりだったんだ。）', { bg: 'bg-aurora', form: 'awaken', kb: true, dur: 2300 }),
        sc('dog', '（あの夜が、こんなにたくさんの未来に枝分かれしたワン。…一個の肉まんから、世界が広がったワン）', { bg: 'bg-aurora', kb: true, dur: 2400 }),
        sc('pepper', '相棒。データを集計した。…君が照らした人が、また別の人を照らす。…連鎖は、もう止まらない。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2400 }),
        sc('peace', '夢って、伝染するんだな。…オレ一人の夢が、いつのまにか、みんなの夢になってる。', { bg: 'bg-aurora', form: 'awaken', kb: true, dur: 2300 }),
        nar('その夜、皆はハルの楽園に集い、ささやかな宴を開いた。あの屋上の夜のように。', { bgImg: 'bg_rooftop.svg', dur: 2100 }),
        sc('gian', 'なあ大将。…あの5万円のお前に、乾杯だ。…あいつがいなきゃ、オレたち、今ここにいねえ。', { bgImg: 'bg_rooftop.svg', kb: true, dur: 2300 }),
        sc('peace', 'やめろよ、ガン太。…乾杯するなら、みんなにだ。…オレ一人じゃ、5万円のままだった。', { bgImg: 'bg_rooftop.svg', kb: true, dur: 2300 }),
        sc('hero', 'はは、相変わらずだな。…じゃあ、全員に乾杯だ。…笑って生きる、俺たちの未来に！', { bgImg: 'bg_rooftop.svg', form: 'gold', fx: 'zoom', kb: true, dur: 2200 }),
        sc('dog', '（みんなの笑い声が、夜空に溶けていくワン。…これが、母さんの言った「一番の財産」ワン）', { bgImg: 'bg_rooftop.svg', kb: true, dur: 2400 }),
        t('夢は、伝播する。', '', { bg: 'bg-aurora', fx: 'flash', dur: 1800, color: '#ffd23b' }) ];

      // 裏第三章 新たな刺客（資産50億）— 買収を仕掛ける大元帥、楽園を狙う。
      case 2: return [ head('〜 新たな刺客 〜', 'bg-fire', '#ff3b3b'),
        nar('資産50億。楽園「ひだまり」は、多くの人の帰る場所になっていた。だが——富は、新たな敵を呼び寄せる。', { bgImg: 'bg_alley.svg', dur: 2200 }),
        nar('ある日、黒塗りの車が、ひだまりの丘の前に止まった。', { bgImg: 'bg_haven.svg', dur: 1900 }),
        sc('general', 'フッ。…これが噂の「楽園」か。…成り上がりの慈善家気取りも、いいところだな。', { bgImg: 'bg_boardroom.svg', form: 'dark', fx: 'shake', kb: true, dur: 2300 }),
        sc('peace', 'あんたは…大元帥。…ここに、何の用だ。', { bgImg: 'bg_haven.svg', kb: true, dur: 2000 }),
        sc('general', '簡単な話だ。…この丘、再開発でタワーが建つ。…私が買収で、貴様の楽園を更地にしてやろう。', { bgImg: 'bg_boardroom.svg', form: 'dark', fx: 'shake', kb: true, dur: 2500 }),
        sc('peace', '更地…だと。…ここには、行き場のない人が、何十人も暮らしてるんだぞ。', { bgImg: 'bg_haven.svg', fx: 'shake', kb: true, dur: 2200 }),
        sc('general', '知らんな。…金にならん人間に、土地を割く方が、罪だ。…これが、経済の摂理だよ。', { bgImg: 'bg_boardroom.svg', form: 'dark', kb: true, dur: 2400 }),
        sc('dog', '（この人の目、お金しか映ってないワン。…昔の闇のマスクより、ずっと冷たいワン）', { bgImg: 'bg_haven.svg', kb: true, dur: 2300 }),
        sc('peace', '金で人の居場所を潰す…か。…あんたは、昔のオレが一番なりたくなかった姿だ。', { bg: 'bg-thunder', kb: true, dur: 2300 }),
        sc('general', 'ほう。…説教か。…成り上がりの分際で。…ならば、力で示そう。…買収合戦だ。受けるかね。', { bgImg: 'bg_boardroom.svg', form: 'dark', fx: 'shake', kb: true, dur: 2400 }),
        sc('pepper', '相棒、待て。…相手の資産、推定80億。…数字では、こちらが劣勢だ。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2200 }),
        sc('peace', '…分かってる。…でも、引けるか。…ここは、みんなの帰る場所だ。', { bgImg: 'bg_haven.svg', kb: true, dur: 2200 }),
        nar('——その夜。楽園の住人たちが、ハルの部屋の前に、静かに集まっていた。', { bgImg: 'bg_haven.svg', dur: 2000 }),
        sc('peace', 'みんな…どうした、こんな夜更けに。', { bgImg: 'bg_haven.svg', kb: true, dur: 1800 }),
        nar('住人の一人が、しわくちゃの封筒を差し出した。中には、なけなしの小銭が入っていた。', { bgImg: 'bg_haven.svg', dur: 2200 }),
        sc('peace', '…これは。…みんなの、なけなしの金、か。…ダメだ、受け取れないよ。', { bgImg: 'bg_haven.svg', fx: 'shake', kb: true, dur: 2300 }),
        sc('dog', '（みんな、ハルを助けたいワン。…自分が助けられた分を、返したいワン）', { bgImg: 'bg_haven.svg', kb: true, dur: 2300 }),
        sc('peace', '（…胸が熱い。…あの定食屋のコロッケと、同じだ。…小さな優しさが、こんなに、重い。）', { bgImg: 'bg_haven.svg', form: 'awaken', kb: true, dur: 2500 }),
        sc('peace', 'みんな…ありがとう。…この気持ちだけ、ちゃんと受け取る。…金は、オレが何とかする。約束だ。', { bgImg: 'bg_haven.svg', kb: true, dur: 2300 }),
        nar('——翌日。買収合戦の火蓋が切られた。市場で、二つの巨富が、激しくぶつかり合う。', { bgImg: 'bg_boardroom.svg', dur: 2100 }),
        sc('general', 'どうした、成り上がり！　…金の力は、夢ごっことは違うぞ！　…株を、根こそぎ買い占めてやる！', { bgImg: 'bg_boardroom.svg', form: 'dark', fx: 'shake', kb: true, dur: 2400 }),
        sc('peace', 'うっ…！　ペッパー、押されてる…！　…向こうの資金力が、桁違いだ…！', { bg: 'bg-speed', fx: 'speed', dur: 1900 }),
        sc('pepper', '相棒、落ち着け。…数字では負けている。…だが相棒、君はいつも、数字を超える。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2200 }),
        nar('——その時。ハルの陣営に、続々と援軍が駆けつけた。', { bg: 'bg-gold', dur: 1800 }),
        sc('hero', '待たせたな、相棒！　俺の財団の資金、全部つぎ込んでやる！　…夢の場所を、潰させはしねえ！', { bg: 'bg-gold', form: 'gold', fx: 'zoom', kb: true, dur: 2300 }),
        sc('gian', '道場の連中も、なけなしの会費出し合ったぜ！　…ガキどもの居場所、守るためならよ！', { bgImg: 'bg_alley.svg', fx: 'shake', kb: true, dur: 2200 }),
        sc('gent', '私の店の常連も、立ち上がりました。…一杯のコーヒーが繋いだ縁、侮れませんよ。', { bgImg: 'bg_diner.svg', kb: true, dur: 2300 }),
        sc('general', 'ばかな…！　…なぜ、こんなに人が集まる…！　…金でもないのに、なぜ動く…！', { bgImg: 'bg_boardroom.svg', form: 'dark', fx: 'shake', kb: true, dur: 2400 }),
        sc('peace', '分からないか、大元帥。…金じゃ買えないものが、世の中にはあるんだ。…それが、人の繋がりだ。', { bg: 'bg-aurora', form: 'awaken', fx: 'zoom', kb: true, dur: 2400 }),
        sc('peace', '母さんが言ってた。…笑ってる人の周りには、人が集まる。…それが、一番の財産だって。', { bg: 'bg-aurora', form: 'awaken', kb: true, dur: 2400 }),
        sc('dog', '（ハルの後ろに、何百人もの想いが集まってるワン。…これが、ハルの本当の資産ワン！）', { bg: 'bg-aurora', fx: 'shake', kb: true, dur: 2300 }),
        sc('general', '（…私には、誰も、いない。…金は、あるのに。…なぜ、こいつの方が、豊かに見える…！）', { bgImg: 'bg_boardroom.svg', form: 'dark', kb: true, dur: 2500 }),
        sc('peace', '受けて立つ。…今度は玉じゃない、覚悟と覚悟の勝負だ！…ここは、絶対に渡さない！', { bg: 'bg-speed', fx: 'burst', shock: true, kb: true, dur: 2100 }),
        nar('数字の上では劣勢。だが、ハルの背には、金では決して買えぬ「人の輪」があった。', { bg: 'bg-thunder', dur: 2200 }),
        sc('general', 'くっ…！　…覚えていろ、成り上がり。…この勝負、まだ終わってはおらん…！', { bgImg: 'bg_boardroom.svg', form: 'dark', fx: 'shake', kb: true, dur: 2200 }),
        sc('peace', 'いつでも来い。…でも、あんたにも、いつか分かるさ。…一人で勝っても、寒いだけだって。', { bg: 'bg-aurora', kb: true, dur: 2300 }),
        t('富の、戦争。', '', { bg: 'bg-thunder', dur: 1800, color: '#ff3b3b' }) ];

      // 裏第四章 世界が動く（資産100億）— 富が市場を動かす。力の責任。
      case 3: return [ head('〜 世界が動く 〜', 'bg-legend'),
        nar('資産100億。気づけば、ハルの一挙手一投足が、世界の市場を揺らすようになっていた。', { bgImg: 'bg_skytree.jpg', dur: 2200 }),
        sc('pepper', '速報。…君が「楽園を世界に増やす」と発言しただけで、関連株が軒並み急騰した。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2300 }),
        sc('peace', 'えっ…オレ、ただ朝のニュースで喋っただけだぞ。…そんなんで、株が動くのか。', { bgImg: 'bg_skytree.jpg', fx: 'shake', kb: true, dur: 2200 }),
        sc('pepper', '動く。…世界が、君を見ている。…君の一言は、もはや、何万人もの生活に直結する。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2400 }),
        sc('peace', '100億…。数字が大きすぎて、もう実感も湧かないな。…昔は5万円で、一喜一憂してたのに。', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2300 }),
        sc('dog', '（ハルの顔、嬉しそうじゃないワン。…むしろ、ちょっと、こわがってるワン）', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2200 }),
        nar('——ある日。ハルのもとに、世界中から、無数の陳情が舞い込むようになった。', { bgImg: 'bg_boardroom.svg', dur: 2000 }),
        sc('pepper', '相談件数、本日だけで一万件超。…飢饉の村、潰れかけた病院、行き場のない子供たち。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2400 }),
        sc('peace', '全部、助けたい。…でも、全部は、無理だ。…オレが選ぶのか。…誰を救って、誰を後回しにするか。', { bgImg: 'bg_boardroom.svg', fx: 'shake', kb: true, dur: 2500 }),
        sc('peace', '（…これが、力を持つってことか。…一つ選ぶたびに、選ばれなかった誰かが、いる。）', { bg: 'bg-rain', kb: true, dur: 2400 }),
        sc('dog', '（ハルの手が、震えてるワン。…5万円の頃には、なかった震えワン。…大きすぎる力の、重さワン）', { bgImg: 'bg_boardroom.svg', kb: true, dur: 2400 }),
        sc('peace', '昔は、自分一人が腹を空かせるだけだった。…今は、オレの一言で、何万人が、笑うか、泣くか決まる。', { bgImg: 'bg_boardroom.svg', kb: true, dur: 2500 }),
        sc('pepper', '相棒。…君は今、神の役割を、求められている。…それは、計算では割り切れない領域だ。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2400 }),
        nar('眠れぬ夜が続いた。100億の重みは、5万円のひもじさとは、別の種類の苦しみだった。', { bgImg: 'bg_rain.svg', dur: 2200 }),
        sc('peace', '…なあモモ。…金がなかった頃の方が、楽だったのかな。…なんて、ぜいたくな悩みだよな。', { bgImg: 'bg_rain.svg', kb: true, dur: 2400 }),
        sc('dog', '（ハル…。…つらい時は、無理に笑わなくていいワン。…でも、一人で抱えちゃダメワン）', { bgImg: 'bg_rain.svg', kb: true, dur: 2400 }),
        nar('——その夜、ハルの夢枕に、懐かしい光が差した。未来の賢者の声だった。', { bg: 'bg-legend', dur: 2000 }),
        sc('legend', '未来の君よ。…苦しんでいるな。…力を持つほど、問われるのは「何のために使うか」だ。', { bg: 'bg-legend', form: 'ghost', kb: true, dur: 2400 }),
        sc('peace', '賢者…。…オレ、全部は救えない。…選ぶのが、こわいんだ。…間違えたら、誰かが、凍える。', { bg: 'bg-legend', kb: true, dur: 2400 }),
        sc('legend', '全てを救う必要はない。…君が灯した火は、また別の誰かが受け継ぐ。…君は、最初の一灯でいい。', { bg: 'bg-legend', form: 'ghost', kb: true, dur: 2500 }),
        sc('legend', '思い出せ。…君が分けたのは、いつも、肉まん半分だった。…大きさではない。…分け合う心だ。', { bg: 'bg-legend', form: 'ghost', kb: true, dur: 2500 }),
        sc('peace', '…そうか。…一人で全部、背負わなくていいんだ。…火は、みんなで、繋いでいくものだ。', { bg: 'bg-aurora', form: 'awaken', kb: true, dur: 2400 }),
        nar('翌朝。ハルは、世界中の仲間に呼びかけた。一人で抱えず、みんなで照らす仕組みを作るために。', { bgImg: 'bg_world.svg', dur: 2200 }),
        sc('peace', 'ヒーロー、ガン太、将軍、ゼ、マスター…！　…力を貸してくれ。…一人じゃ、世界は救えない。', { bgImg: 'bg_world.svg', fx: 'zoom', kb: true, dur: 2400 }),
        sc('hero', '当然だろ、相棒。…お前が灯した火を、世界中に運ぶ。…それが、俺たちの役目だ。', { bg: 'bg-gold', form: 'gold', kb: true, dur: 2300 }),
        sc('alien', '我ノ星ノ技術モ、使エ。…地球中ノ、凍エル者ヲ、温メヨウ。…笑顔ノ、ネットワークヲ。', { bgImg: 'bg_world.svg', kb: true, dur: 2400 }),
        sc('pepper', '相棒。…君一人なら一万人。…だが、仲間と組めば、百万人を救える。…これが、最適解だ。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2400 }),
        sc('peace', '分かってる。…母さんの言葉も、モモとの約束も…全部、ここにある。…力は、独り占めしない。', { bg: 'bg-aurora', form: 'awaken', kb: true, dur: 2300 }),
        sc('dog', '（ハルの目に、また光が戻ったワン。…一人で背負わないって決めたら、こんなに強くなったワン）', { bg: 'bg-aurora', kb: true, dur: 2300 }),
        nar('世界中に、ひだまりの灯が、次々と灯り始めた。一つの火が、無数の火を、呼んでいく。', { bgImg: 'bg_world.svg', dur: 2300 }),
        sc('peace', '（母さん。…力ってのは、独り占めするものじゃない。…分け合うほど、大きくなるんだな。）', { bgImg: 'bg_world.svg', form: 'awaken', kb: true, dur: 2400 }),
        sc('black', '…見事だ、ハル。…私は、力を、孤独に使った。…お前は、繋がりに使う。…だから、お前は、堕ちない。', { bgImg: 'bg_world.svg', kb: true, dur: 2400 }),
        sc('peace', '戦友…！　来てくれたのか。…ああ、もう、一人で抱え込まない。…あんたの孤独の轍は、踏まないよ。', { bgImg: 'bg_world.svg', kb: true, dur: 2400 }),
        sc('peace', '100億の力。…使い道は、決めた。…世界中の誰も、凍えさせない。…それが、オレの責任だ。', { bg: 'bg-aurora', form: 'awaken', fx: 'zoom', kb: true, dur: 2400 }),
        t('百億の、責任。', '', { bg: 'bg-legend', dur: 1800, color: '#ff6ec7' }) ];

      // 裏第五章 富の孤独（資産500億）— 闇のマスクの警告が現実に。モモと仲間が救う。
      case 4: return [ head('〜 富の孤独 〜', 'bg-space', '#9d86c4'),
        nar('資産500億。世界が、ハルの足元にひれ伏した。…だが、ある朝、彼は、ふと足を止めた。', { bgImg: 'bg_skytree.jpg', dur: 2300 }),
        nar('あまりに、遠くまで来すぎた。…見上げる人ばかりで、隣を歩く者の顔が、霞んで見えた。', { bgImg: 'bg_skytree.jpg', dur: 2300 }),
        sc('peace', '…なあモモ。…オレ、いつのまにか、雲の上にいるみたいだ。…ちょっと、こわいよ。', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2400 }),
        sc('peace', 'どこへ行っても、頭を下げられる。…笑いかけられる。…でも、その笑顔、オレを見てるのかな。', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2400 }),
        sc('peace', 'それとも、500億を見てるのかな。…最近、分からなくなってきた。', { bg: 'bg-space', kb: true, dur: 2300 }),
        sc('dog', '（ハルの声、震えてるワン。…あの闇のマスクと、同じ場所に、立ちかけてるワン…）', { bg: 'bg-space', kb: true, dur: 2300 }),
        nar('その夜。ハルは、ひとり、広すぎる部屋の窓辺に座っていた。眼下に、無数の街の灯。', { bgImg: 'bg_skytree.jpg', dur: 2200 }),
        sc('peace', '（闇のマスクが言ってた。…「掴んだ栄光は、分かち合う者がなく、ただ冷たかった」って…）', { bg: 'bg-space', kb: true, dur: 2500 }),
        sc('peace', '（あいつは、頂で独りだった。…オレも、いつのまにか、同じ高さに、いるのか…？）', { bg: 'bg-space', form: 'dark', kb: true, dur: 2500 }),
        sc('peace', '金は、いくらでもある。…なのに、なんで、こんなに、心が寒いんだ。…なあ、母さん。', { bg: 'bg-space', kb: true, dur: 2400 }),
        nar('彼の手から、温もりが、少しずつ失われていく。…あの日、闇のマスクが堕ちた、孤独の淵。', { bgImg: 'bg_hell.svg', dur: 2200 }),
        sc('dog', '（ダメだワン!!　…ハル、そっちに行っちゃダメワン!!）', { bg: 'bg-space', fx: 'shake', kb: true, dur: 2000 }),
        nar('——その時。モモが、ハルの膝に、そっと前足を乗せた。…昔と、何ひとつ変わらない、温もり。', { bgImg: 'bg_skytree.jpg', dur: 2200 }),
        sc('dog', '（ハル。…下を見てごらんワン。…モモは、ここにいるワン。…5万円の頃と、同じ場所にワン）', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2400 }),
        sc('peace', '…モモ。…お前、あの雨の日から、ずっと、変わらないな。…オレが5万円でも、500億でも。', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2400 }),
        sc('dog', '（当たり前ワン。…モモが好きなのは、ハルの財布じゃなくて、ハルの笑顔ワン。…昔から、ずっとワン）', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2500 }),
        nar('——その時、部屋の扉が開いた。仲間たちが、なだれ込んできた。', { bg: 'bg-gold', dur: 1900 }),
        sc('gian', 'よお大将！　…なに辛気くせえ顔してんだ。…ほら、肉まん買ってきたぜ。…一個な。', { bgImg: 'bg_skytree.jpg', fx: 'zoom', kb: true, dur: 2200 }),
        sc('peace', 'ガン太…！　…なんで、お前ら、ここに。…つーか、一個って、何人いると思ってんだ。', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2200 }),
        sc('hero', '決まってんだろ。…昔みたいに、分け合うのさ。…500億あっても、肉まん一個を分ける夜が、一番うまい。', { bg: 'bg-gold', form: 'gold', kb: true, dur: 2400 }),
        sc('gorilla', 'ウホ。…バナナも、持ってきた。…お前は、一人ではない。…我らが、隣にいる。…忘れるな。', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2300 }),
        sc('alien', 'ハル。…キミハ、500億ノ男デハナイ。…肉まんヲ分ケテクレタ、優シイ男ダ。…ソレダケダ。', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2400 }),
        sc('pepper', '相棒。…君が一人で窓辺に座る座標を、私は常時監視していた。…仲間を呼んだのは、私だ。…余計だったか。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2500 }),
        sc('peace', 'ペッパー…。…お前が。…いや、…余計なもんか。…最高の、お節介だよ。…ありがとうな、相棒。', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2400 }),
        sc('peace', 'みんな…。…（涙）…ばか野郎…。…こんな、夜更けに…。…ありがとう…ありがとうな…。', { bgImg: 'bg_skytree.jpg', fx: 'shake', kb: true, dur: 2500 }),
        nar('熱い肉まんを、皆で、ふうふう言いながら、分け合った。…あの安アパートの夜と、同じように。', { bgImg: 'bg_skytree.jpg', dur: 2300 }),
        sc('pepper', '相棒。…君の幸福度ログが、急回復した。…要因は所持金ではない。…「分け合う温もり」だ。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2400 }),
        sc('peace', '…そうだな。…オレは、独りじゃない。…あいつとは、違う。…ちゃんと、隣に、みんながいる。', { bg: 'bg-aurora', form: 'awaken', kb: true, dur: 2400 }),
        sc('peace', '（闇のマスク。…あんたの言葉、忘れてないよ。…でも、オレは、堕ちずにすんだ。…仲間のおかげだ。）', { bg: 'bg-aurora', form: 'awaken', kb: true, dur: 2500 }),
        sc('dog', '（ハルの目に、また温かい光が戻ったワン。…よかったワン。…本当に、よかったワン…）', { bg: 'bg-aurora', kb: true, dur: 2300 }),
        nar('富がどれほど高くとも、隣に分け合う者がいれば、人は凍えない。…ハルは、それを、身をもって知った。', { bg: 'bg-aurora', dur: 2300 }),
        sc('peace', 'ありがとう、モモ。…ありがとう、みんな。…オレ、大事なこと、忘れるとこだった。', { bg: 'bg-aurora', form: 'awaken', fx: 'zoom', kb: true, dur: 2300 }),
        sc('peace', '金は、目的じゃない。…分け合う相手がいて、初めて、意味を持つ。…うん。…もう、こわくない。', { bg: 'bg-aurora', form: 'awaken', kb: true, dur: 2400 }),
        t('高みの、孤独と温もり。', '', { bg: 'bg-aurora', fx: 'flash', dur: 1800, color: '#ffd23b' }) ];

      // 裏第六章 闇のマスク、再び（資産1兆）— 宿敵が、戦友として帰ってくる。
      case 5: return [ head('〜 約束の再会 〜', 'bg-legend', '#ff6ec7'),
        nar('資産1兆。ハルの楽園は、世界中に広がっていた。…そして、ある日。', { bgImg: 'bg_shrine.svg', dur: 2100 }),
        nar('かつて二人が運命を語り合った、あの古い神社の片隅に、見覚えのある影が立っていた。', { bgImg: 'bg_shrine.svg', dur: 2200 }),
        sc('peace', 'あの背中は…。…まさか。…おい、あんた。…顔を、見せてくれよ。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2100 }),
        sc('black', '…久しいな、小僧。…いや——ハル。…見事に、約束を果たしたようだ。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2300 }),
        sc('peace', '闇のマスク…！　あんた、生きてたのか。…その顔、ずいぶん、穏やかになったな。', { bgImg: 'bg_shrine.svg', fx: 'zoom', kb: true, dur: 2300 }),
        sc('black', 'ああ。…あの決戦の日。…お前が見せてくれた「温もり」が、忘れられなくてな。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2400 }),
        nar('かつて夢を憎んだ男の声には、もう、あの冷たい棘はなかった。', { bgImg: 'bg_shrine.svg', dur: 2000 }),
        sc('black', 'あれから、私は、旅に出た。…昔、私が切り捨てた、仲間たちを、探す旅にな。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2400 }),
        sc('peace', '…切り捨てた、仲間を。…会えたのか。…ちゃんと、謝れたのか。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2200 }),
        sc('black', '…ああ。…幾人かは、もう、この世にいなかった。…だが、残った者は、…私を、許してくれた。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2500 }),
        sc('black', '「ずっと、待っていた」と。…そう言って、泣いてくれた。…私は、その時、初めて、…人前で泣いた。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2600 }),
        sc('peace', '……っ。…そうか。…あんた、ちゃんと、取り戻せたんだな。…自分で捨てた、温もりを。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2400 }),
        sc('dog', '（闇のマスクの顔、あんなに優しいワン。…もう、寒い場所にはいないワン。…よかったワン…）', { bgImg: 'bg_shrine.svg', kb: true, dur: 2400 }),
        nar('二人は、神社の石段に並んで腰を下ろした。…かつて、夢を巡って激突した、宿敵同士が。', { bgImg: 'bg_shrine.svg', dur: 2100 }),
        sc('black', 'お前は、私が見れなかった景色を、見せてくれた。…仲間と掴んだ夢は、…本当に、温かいのだな。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2400 }),
        sc('peace', 'あんたが、教えてくれたんだよ。…一人で頂に立つ、その寒さをさ。…だから、オレは堕ちずにすんだ。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2400 }),
        sc('black', '…フッ。…憎まれ役も、たまには、役に立つものだ。…私の孤独が、お前を、救ったというなら、…本望だ。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2500 }),
        sc('peace', 'なあ。…一つ、頼みがあるんだ。…あんたの、その経験。…オレの楽園で、活かしてくれないか。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2400 }),
        sc('black', '…私が、か。…かつて夢を憎んだ、この私が。…お前の、楽園で。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2300 }),
        sc('peace', 'ああ。…夢に破れて、堕ちかけた奴の気持ちが、誰よりわかるのは、あんただろ。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2400 }),
        sc('peace', '夢に疲れた人を、もう一度、立ち上がらせる。…それができるのは、あんたしかいない。', { bgImg: 'bg_shrine.svg', fx: 'zoom', kb: true, dur: 2400 }),
        sc('black', '……ハル。…お前は、本当に、…とんでもない男だ。…宿敵さえ、こうも、たやすく、味方にしてしまう。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2400 }),
        sc('pepper', '相棒。…観測した。…闇のマスクの口元が、わずかに緩んでいる。…これは、笑顔だ。…記録する。ピピッ。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2400 }),
        sc('black', 'ロボよ。…そう、じろじろ観測するな。…照れる、ではないか。…まったく、お前の相棒に、似て、お節介だ。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2500 }),
        sc('peace', 'はは、ペッパーのお節介は、筋金入りだぞ。…でも、悪くないだろ？　…そういう仲間が、いるってのは。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2400 }),
        sc('black', '…ああ。…悪く、ない。…むしろ、…眩しいほどに、温かい。…私が、ずっと、欲しかったものだ。', { bgImg: 'bg_shrine.svg', kb: true, dur: 2500 }),
        sc('dog', '（あの、こわかった闇のマスクが、笑ってるワン。…ハルの温もりが、宿敵まで溶かしたワン）', { bgImg: 'bg_shrine.svg', kb: true, dur: 2400 }),
        nar('二人は、夕暮れの神社で、固く、握手を交わした。…長い、長い宿命に、決着がついた瞬間だった。', { bgImg: 'bg_shrine.svg', dur: 2300 }),
        sc('peace', '……来いよ。…この楽園、まだ席は空いてる。…一緒に、誰かを照らそうぜ。…戦友。', { bg: 'bg-aurora', form: 'awaken', fx: 'zoom', kb: true, dur: 2400 }),
        sc('black', '…戦友、か。…悪く、ないな。…ああ。…今度は、独りでは、登らない。…お前の隣で、登らせてもらおう。', { bg: 'bg-aurora', kb: true, dur: 2500 }),
        sc('peace', '（母さん。…見てるか。…あんなに、夢を憎んでた人まで、笑えるようになったよ。）', { bg: 'bg-aurora', form: 'awaken', kb: true, dur: 2400 }),
        sc('legend', '——未来の君よ。…宿敵と、戦友になる。…それこそが、お前の夢が見せた、最も美しい奇跡だ。', { bg: 'bg-legend', form: 'ghost', kb: true, dur: 2400 }),
        sc('black', 'ハル。…あの日、お前の夢を笑った私を、…許せ。…そして、…ありがとう。…私を、人間に戻してくれて。', { bg: 'bg-aurora', kb: true, dur: 2500 }),
        sc('peace', '水くさいこと言うなよ、戦友。…さあ、行こう。…凍えてる奴が、まだ、いっぱい待ってる。', { bg: 'bg-aurora', form: 'awaken', fx: 'zoom', kb: true, dur: 2300 }),
        t('宿敵は、戦友へ。', '', { bg: 'bg-aurora', fx: 'burst', shock: true, dur: 1900, color: '#ffd23b' }) ];

      // 裏第七章 経済の支配者（資産10兆）— 国家を動かす規模。数えるのは「笑顔の数」。
      case 6: return [ head('〜 経済の支配者 〜', 'bg-gold'),
        nar('資産10兆。もはやハルの名は、一国の経済をまるごと動かす規模になっていた。', { bgImg: 'bg_skytree.jpg', dur: 2300 }),
        sc('pepper', '報告する。…君の財団の支援先、累計100万人を突破した。…「凍える人をなくす」が、現実になりつつある。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2500 }),
        sc('peace', '100万人…。…でもなペッパー。…オレが数えてるのは、金額じゃない。…救えた「笑顔の数」だ。', { bg: 'bg-gold', form: 'awaken', kb: true, dur: 2400 }),
        sc('dog', '（ハルの机の上、お金の帳簿じゃなくて、助けた人からの手紙が、山積みワン。…宝物ワン）', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2400 }),
        sc('peace', 'この手紙、一枚一枚に、笑顔が一つ。…これが、オレの本当の貯金通帳だ。…減らない、増える一方の通帳さ。', { bgImg: 'bg_skytree.jpg', kb: true, dur: 2500 }),
        nar('——ある日。困窮にあえぐ、ひとつの小国から、国家ぐるみの支援要請が届いた。', { bgImg: 'bg_boardroom.svg', dur: 2100 }),
        sc('pepper', '相棒。…ある国が、財政破綻寸前だ。…国民の三分の一が、明日の食事にも困っている。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2400 }),
        sc('peace', '国ごと…か。…10兆あれば、一つの国を、丸ごと温められる。…でも、それでいいのかな。', { bgImg: 'bg_boardroom.svg', kb: true, dur: 2400 }),
        sc('black', 'ハル。…金を渡すだけでは、人は、誇りを失う。…私が、孤独に堕ちたのと、同じだ。', { bgImg: 'bg_boardroom.svg', kb: true, dur: 2400 }),
        sc('peace', '…そうだな、戦友。…魚を渡すんじゃない。…釣り方を、一緒に考える。…それが、本当の支援だ。', { bgImg: 'bg_boardroom.svg', form: 'awaken', kb: true, dur: 2400 }),
        nar('ハルは、その国へ自ら足を運んだ。…大富豪としてではなく、ひとりの人間として。', { bgImg: 'bg_haven.svg', dur: 2100 }),
        sc('peace', 'はじめまして。…ハルです。…まずは、一緒に、ごはんを食べさせてください。…話は、それからだ。', { bgImg: 'bg_haven.svg', kb: true, dur: 2300 }),
        sc('dog', '（ハル、王様みたいに偉ぶらないワン。…現地の子供と、地べたに座って、肉まん分けてるワン）', { bgImg: 'bg_haven.svg', kb: true, dur: 2400 }),
        sc('peace', 'うまいだろ、肉まん。…昔、オレもこれを、仲間と分け合って、生きてきたんだ。', { bgImg: 'bg_haven.svg', kb: true, dur: 2300 }),
        nar('ハルは、金を配るのではなく、産業を、学校を、医療を、現地の人々と「共に」築き上げた。', { bgImg: 'bg_world.svg', dur: 2300 }),
        sc('gorilla', 'ウホ。…この国の土も、肥える。…バナナの育て方、教えよう。…腹が満ちれば、人は、立てる。', { bgImg: 'bg_haven.svg', kb: true, dur: 2400 }),
        sc('hero', '俺の財団も、全面協力だ。…子供たちに、夢を諦めない心を教える。…未来は、自分で掴むものだってな。', { bg: 'bg-gold', form: 'gold', kb: true, dur: 2400 }),
        sc('gent', 'ささやかながら、私の店の淹れ方も。…一杯の温かさが、人を繋ぐ。…それを、この国にも。', { bgImg: 'bg_haven.svg', kb: true, dur: 2300 }),
        sc('alien', '我ノ星ノ農業技術モ、惜シマズ与エヨウ。…笑顔ノ種ヲ、コノ星中ニ、蒔クノダ。', { bgImg: 'bg_world.svg', kb: true, dur: 2400 }),
        sc('gian', '道場も、現地に開くぜ！　…子供らに「奪う」んじゃなく「守る」強さを教える。…居場所は、自分で作るもんだとな。', { bgImg: 'bg_haven.svg', kb: true, dur: 2500 }),
        sc('peace', 'みんな…。…ありがとう。…一人なら、10兆あっても、一つの国も救えなかった。…仲間がいて、初めてだ。', { bgImg: 'bg_haven.svg', form: 'awaken', kb: true, dur: 2500 }),
        nar('一年後。その国の飢餓は、過去のものとなった。…街には、子供たちの笑い声が、満ちていた。', { bgImg: 'bg_haven.svg', dur: 2300 }),
        sc('pepper', '相棒。…驚異的なデータだ。…君が動かした10兆は、巡り巡って、その国のGDPを倍にした。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2400 }),
        sc('peace', '…数字は、もういいよ、ペッパー。…それより、見てくれ。…あの、子供たちの、笑顔をさ。', { bg: 'bg-gold', form: 'awaken', kb: true, dur: 2400 }),
        sc('pepper', '…訂正する。…最も重要なデータを、報告し忘れた。…本日のこの国の、笑顔の数——計測不能。ピピッ。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2500 }),
        sc('peace', 'はは。…それが、聞きたかったんだ。…ありがとな、相棒。', { bg: 'bg-gold', kb: true, dur: 2000 }),
        sc('hero', '相棒、お前はもう、ただの大富豪じゃない。…時代そのものだ。…経済を、笑顔で動かす男さ。', { bg: 'bg-gold', form: 'gold', kb: true, dur: 2300 }),
        sc('black', '…思えば、私は、経済を、恐怖で動かそうとした。…お前は、笑顔で動かす。…器が、違いすぎる。', { bgImg: 'bg_boardroom.svg', kb: true, dur: 2400 }),
        sc('peace', '器なんて、関係ないさ、戦友。…ただ、母さんの言葉を、信じてるだけだ。', { bg: 'bg-gold', kb: true, dur: 2200 }),
        sc('peace', '笑ってる人の周りには、人が集まる。…それが、一番の財産。…これは、経済でも、同じだったんだ。', { bg: 'bg-gold', form: 'awaken', fx: 'zoom', kb: true, dur: 2500 }),
        sc('dog', '（母さんが言ってた「一番の財産」…ハルは、世界中に、増やしたワン。…国ごと、笑顔にしたワン）', { bg: 'bg-aurora', kb: true, dur: 2400 }),
        nar('10兆という富は、もはや数字ではなかった。…それは、地球上に灯った、無数の笑顔の、総量だった。', { bg: 'bg-aurora', dur: 2300 }),
        sc('peace', '（母さん。…オレ、金持ちになった。…でも、一番増やせたのは、お金じゃなくて、笑顔だったよ。）', { bg: 'bg-aurora', form: 'awaken', kb: true, dur: 2500 }),
        t('十兆の、笑顔。', '', { bg: 'bg-legend', dur: 1800, color: '#ff6ec7' }) ];

      // 裏最終章 世界の頂点（資産100兆）— 真の最終エンディング。笑って生きた男の伝説。
      default: return [ head('〜 世界の頂点 〜', 'bg-legend', '#ff6ec7'),
        ...
        nar('かつて、財布に5万円しかなく、自販機にコインを飲み込まれて泣いた、あの男が。', { bgImg: 'bg_city.svg', dur: 2300 }),
        sc('peace', 'あの5万円のオレが…世界のてっぺんに。…夢って、本当に、叶うんだな。', { bgImg: 'bg_skytree.jpg', fx: 'zoom', kb: true, dur: 2400 }),
        nar('ハルは、すべての始まりの場所——母と過ごした、あの小さな公園のベンチに、座っていた。', { bgImg: 'bg_park.svg', dur: 2300 }),
        sc('peace', '（母さん。…約束、覚えてるか。…次にここに座る時は、笑い話を持って帰るって。）', { bgImg: 'bg_park.svg', form: 'awaken', kb: true, dur: 2500 }),
        sc('peace', '（…笑い話、たくさん、持って帰ってきたよ。…とびきりの、やつをさ。）', { bgImg: 'bg_park.svg', form: 'awaken', kb: true, dur: 2400 }),
        nar('そのベンチに、かつての仲間たちが、一人、また一人と、集まってきた。', { bgImg: 'bg_park.svg', dur: 2100 }),
        sc('gian', 'よお、大将。…いや、もう、世界の大将か。…はは、出会った頃のお前に、教えてやりてえな。', { bgImg: 'bg_park.svg', kb: true, dur: 2300 }),
        sc('hero', '5万円が100兆。…俺たちが助けたつもりが、結局、一番でかい夢を見せてもらったのは、俺たちさ。', { bg: 'bg-gold', form: 'gold', kb: true, dur: 2400 }),
        sc('gorilla', 'ウホ。…お前の隣は、いつも、温かかった。…それだけで、十分すぎる、報酬だった。', { bgImg: 'bg_park.svg', kb: true, dur: 2300 }),
        sc('alien', 'ハル。…我、地球ニ来テ、ヨカッタ。…キミニ、出会エテ、ヨカッタ。…コレガ、宇宙一ノ、財産ダ。', { bgImg: 'bg_park.svg', kb: true, dur: 2400 }),
        sc('black', 'フッ…見事だ、ハル。…お前こそ、真の伝説だ。…あの日、夢を笑った私を、…もう一度、許せ。', { bgImg: 'bg_park.svg', kb: true, dur: 2400 }),
        sc('peace', '何度でも許すさ、戦友。…あんたがいてくれたから、オレは、踏みとどまれた。…ありがとう。', { bgImg: 'bg_park.svg', kb: true, dur: 2300 }),
        sc('pepper', '相棒。…最後に、生涯の計算結果を報告する。…君の成功確率、当初0.0002%。…結果——100%。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2500 }),
        sc('pepper', '私の回路は、間違っていた。…そして、その間違いを、…誇りに思う。…ありがとう、相棒。ピピッ。', { bgImg: 'bg_cosmos.svg', kb: true, dur: 2500 }),
        sc('peace', '…こちらこそだよ、ペッパー。…お前がいなきゃ、最初の一玉も、打てなかった。', { bg: 'bg-aurora', kb: true, dur: 2200 }),
        sc('legend', '——100兆。…もはや、国家を超えた。…君は、歴史そのものだ。', { bg: 'bg-legend', form: 'ghost', fx: 'burst', kb: true, dur: 2300 }),
        sc('peace', '歴史、か。…そんな大層なもんじゃないよ、賢者。…オレはただ、母さんとの約束を、守っただけだ。', { bg: 'bg-aurora', form: 'awaken', kb: true, dur: 2400 }),
        sc('peace', 'あの5万円のオレが…世界のてっぺんに。…でもさ、一番の宝物は、最初から手の中にあったんだ。', { bg: 'bg-aurora', form: 'awaken', fx: 'zoom', kb: true, dur: 2600 }),
        sc('peace', '笑ってる人の周りには、人が集まる。…それが、一番の財産。…母さん、あんたの言葉は、正しかったよ。', { bg: 'bg-aurora', form: 'awaken', kb: true, dur: 2600 }),
        sc('dog', '（モモ、誇らしいワン。…ずっと、君のそばにいられて、…幸せだったワン。…本当に、幸せだったワン）', { bg: 'bg-aurora', kb: true, dur: 2500 }),
        sc('peace', 'モモ…。…お前を拾った、あの雨の日が、オレの人生で、一番の大当りだったよ。…ありがとうな。', { bg: 'bg-aurora', form: 'awaken', kb: true, dur: 2500 }),
        sc('gian', 'なあ大将。…昔、お前の出玉、奪おうとして悪かったな。…今は、お前の夢を、守る側でいられて、誇らしいぜ。', { bgImg: 'bg_park.svg', kb: true, dur: 2500 }),
        sc('black', '…ハル。…一つだけ、聞かせてくれ。…5万円のあの日に戻れるなら、…お前は、もう一度、同じ道を選ぶか。', { bgImg: 'bg_park.svg', kb: true, dur: 2500 }),
        sc('peace', '迷わず選ぶさ、戦友。…だって、この道の先に、お前たちがいる。…仲間に会うためなら、何度でも、5万円から始める。', { bgImg: 'bg_park.svg', form: 'awaken', kb: true, dur: 2600 }),
        nar('夕暮れの公園。100兆の男は、拾い犬を膝に乗せ、仲間に囲まれ、ただ、笑っていた。', { bgImg: 'bg_park.svg', dur: 2300 }),
        nar('それは、世界一の富豪の姿ではなかった。…ただ、世界一、幸せそうな、ひとりの男の姿だった。', { bgImg: 'bg_park.svg', dur: 2400 }),
        sc('peace', 'なあ、みんな。…金は、ぜんぶ使い切ったって、また稼げる。…でも、この時間は、二度と戻らない。', { bgImg: 'bg_park.svg', kb: true, dur: 2400 }),
        sc('peace', 'だから、今を、笑って生きよう。…それが、母さんがオレに遺してくれた、たった一つの、宝物だ。', { bgImg: 'bg_park.svg', form: 'awaken', fx: 'zoom', kb: true, dur: 2600 }),
        sc('peace', '（母さん。…見ててくれよ。…オレは、最後まで、笑って生きるから。）', { bg: 'bg-aurora', form: 'awaken', kb: true, dur: 2400 }),
        nar('——西暦20XX。…たった5万円から始まった、ひとりの男の物語は、こうして、伝説になった。', { bg: 'bg-legend', dur: 2400 }),
        nar('彼が遺したのは、100兆の富ではない。…世界中に灯した、数えきれない、笑顔だった。', { bg: 'bg-legend', dur: 2400 }),
